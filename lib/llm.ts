...
const schema = z.object({
  hs: z.object({
    ...
    explanation: z.string().describe("A brief explanation of your reasoning for assigning this score. This should be a single sentence that captures the essence of the score."),
  }),
  ie: z.object({
    score: score.describe("Interaction Effort (IE): Measures the amount of effort required by customers when interacting with AI, focusing on the clarity, intuitiveness, and brevity of the experience. This factor includes how many steps or clarifications the customer has to go through before resolution. A value between 1 and 5."),
    explanation: z.string().describe("A brief explanation of your reasoning for assigning this score. This should be a single sentence that captures the essence of the score."),
  }),
  ra: z.object({
    score: score.describe("Resolution Accuracy (RA): Measures how accurately the AI system resolves customer inquiries or correctly routes them. If a customer question or issue is accurately resolved by AI without human intervention, it reflects a successful use of AI. A value between 1 and 5."),
    explanation: z.string().describe("A brief explanation of your reasoning for assigning this score. This should be a single sentence that captures the essence of the score."),
  }),
})
